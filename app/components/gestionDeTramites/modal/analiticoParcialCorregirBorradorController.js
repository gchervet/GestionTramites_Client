angular.module('app')
    .controller('analiticoParcialCorregirBorradorController', function ($scope, $routeParams, $rootScope, $location, Auth, $uibModal, utilityService, data, $uibModalInstance, workflowService) {
