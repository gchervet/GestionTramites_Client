angular.module('app')
    .controller('analiticoFinalConfeccionaAnexoController', function ($scope, $routeParams, $rootScope, $location, Auth, $uibModal, utilityService, data, $uibModalInstance, workflowService) {
