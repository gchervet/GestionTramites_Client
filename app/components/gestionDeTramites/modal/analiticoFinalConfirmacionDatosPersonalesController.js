angular.module('app')
    .controller('analiticoFinalConfirmacionDatosPersonalesController', function ($scope, $routeParams, $rootScope, $location, Auth, $uibModal, utilityService, data, $uibModalInstance, workflowService, filemanagerService) {
        ...
        confirmacionDatosPersonalesController.updateDatosPersonalesCallback = function (response) {
            if(response){
                ...
                var modalInstance = $uibModal.open({
                    ...
                    templateUrl: 'app/components/gestionDeTramites/modal/analiticoFinalEstadoAcademico.html',
                    controller: 'analiticoFinalEstadoAcademicoController as vm',
                    size: 'lg',
                    backdrop: 'static',
                    keyboard: false,
                    resolve: {
