angular.module('app')
    .controller('analiticoFinalTramiteObservadoController', function ($scope, $routeParams, $rootScope, $location, Auth, $uibModal, utilityService, data, $uibModalInstance, workflowService) {

        var tramiteObservadoController = this;

        tramiteObservadoController.legajo = undefined;

        tramiteObservadoController.idPantalla = data.Pantalla.IdPantalla;
        data.idPantalla = data.Pantalla.IdPantalla;
        tramiteObservadoController.data = data;
        tramiteObservadoController.observado = false;

        tramiteObservadoController.init = function () {
            Auth.tokenCookieExists();
        };

        tramiteObservadoController.cancel = function () {
            var data = {
        ...
        tramiteObservadoController.next = function () {
            ...
            var estadoInstanciaData = tramiteObservadoController.data;
            ...
            valoresSalida.Observado = tramiteObservadoController.observado;
            ...
            success_updateEstadoInstancia_Request = function (response) {
                workflowService.getNextEstadoByIdEstadoActual(tramiteObservadoController.data.IdEstadoDefinicion, true, tramiteObservadoController.data);
