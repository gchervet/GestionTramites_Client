angular.module('app')
    .controller('duplicadoAnaliticoCorregirSolicitudController', function ($scope, $routeParams, $rootScope, $location, Auth, $uibModal, utilityService, data, $uibModalInstance, workflowService) {
