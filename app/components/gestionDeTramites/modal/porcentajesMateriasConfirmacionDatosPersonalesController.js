angular.module('app')
    .controller('porcentajesMateriasConfirmacionDatosPersonalesController', function ($scope, $routeParams, $rootScope, $location, Auth, $uibModal, utilityService, data, $uibModalInstance, workflowService) {
        ...
        confirmacionDatosPersonalesController.updateDatosPersonalesCallback = function (response) {
            if(response){
                var modalInstance = $uibModal.open({
                    ...
                    templateUrl: 'app/components/gestionDeTramites/modal/porcentajesMateriasEstadoAcademico.html',
                    controller: 'porcentajesMateriasEstadoAcademicoController as vm',
                    size: 'lg',
                    backdrop: 'static',
                    keyboard: false,
                    resolve: {
